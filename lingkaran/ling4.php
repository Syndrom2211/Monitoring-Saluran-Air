...
float:left;
width:73px;
background:url('../style/images/merah.gif');
height:73px;
color:white;
font-weight:bold;
border-radius:100px;
...
<div class="tombolempat">
  <form name="form" action="" method="post">
    ...
    $sql = "INSERT INTO tbl_sensor4(id_sensor4,ketinggian,status_mengalir,periode,jam) values ('','$ketinggian','$status_mengalir','$periode','$jam')";
...
?>
  ...
  <div id="merah">
    ...
    <font style="padding-left:32px;padding-top:10px;">4</font>
  </div>
<?php
...
?>
  <div id="hijau">
    <input class="tombolnampil" style="text-align:center;" name="nilai" type="text" readonly value="<?php echo $_POST['nilai']; ?>" maxlength="4" />
    <font style="padding-left:32px;">4</font>
  </div>
<?php
