...
-webkit-border-radius:100px;
  ...
  <div class="tombolsatu">
    <form name="form" action="" method="post">
      ...
      $sql = "INSERT INTO tbl_sensor1(id_sensor1,ketinggian,status_mengalir,periode,jam) values ('','$ketinggian','$status_mengalir','$periode','$jam')";
      ...
      ?>
        ...
        <div id="merah">
          ...
          <font style="padding-left:32px;padding-top:10px;">1</font>
        </div>
      <?php
      ...
      ?>
        <div id="hijau">
          <input class="tombolnampil" style="text-align:center;" name="nilai" type="text" readonly value="<?php echo $_POST['nilai']; ?>" maxlength="4" />
          <font style="padding-left:32px;">1</font>
        </div>
      <?php
